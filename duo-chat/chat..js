class Chat {
	 ...
	 * */ 
		constructor(obj) {	
			...
			// This Cell attribute
			this._maxNumLines = null;
			this._maxLinesHeight = null;
		...
		compareMaxHeight(maxNumChar = 500) {
			...
			height = this.comparor.clientHeight - paddingTop - paddingBot;
		...
		computeMaxHeight(maxNumChar = 500){
			...
			this._maxNumLines = Math.floor(height / this.lineHeight);
			this._maxLinesHeight = this.maxNumLines * this.lineHeight;
